...
//       printVector(publishPosition, 0);
    ...
    std::copy_n(publishPosition.begin(), publishPosition.size(),
                lastPosition.begin());
//    printf("\nlastPosition Vector after copy: ");
//    printVector(lastPosition, 0);
//    printf("\npublishPos after copy: ");
//    printVector(publishPosition, 0);
    // ----------------------------
...
int main(int argc, char** argv) {
  ...
  */
  ...
  while (node.ok()) {
    ...
    printf("\nGoal tf Transform baselink to righthand:");
    printf("\n ox: %f oy: %f oz:%f rx:%f ry:%f rz:%f",
           tfPNIntf.transBaseLinkRightHand.getOrigin().getX(),
           tfPNIntf.transBaseLinkRightHand.getOrigin().getY(),
           tfPNIntf.transBaseLinkRightHand.getOrigin().getZ(),
           tfPNIntf.transBaseLinkRightHand.getRotation().getX(),
           tfPNIntf.transBaseLinkRightHand.getRotation().getY(),
           tfPNIntf.transBaseLinkRightHand.getRotation().getZ());
