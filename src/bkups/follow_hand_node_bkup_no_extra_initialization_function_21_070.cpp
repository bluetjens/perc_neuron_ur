...
//                 i = 7 : elbow up;    shoulder right;     wrist up / away from body
    */
    ...
    success = -1;
    while(success == -1){
        success = getTransBaseLinkRightHand(bodyJointsRef, listenerRef, broadcasterRef, transBaseLinkRightHandRef, &rotate); // returns 0 for success
    }
    printf("\n got first transform from baselink to right hand");
